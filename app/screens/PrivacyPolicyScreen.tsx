    ...
    <Screen preset="scroll" style={$screen}>
      ...
      <View style={$policyContainer}>
        <Text>
          ...
          the terms of this Agreement, do not download or use the Application. Hikma Health ("us",
          "we", or "our") operates the Hikma Health application (“Application”). This page informs
          you of our policies regarding the collection, use and disclosure of Personal Information
          we receive from users of the Application. The Application is an open source application
          and is provided by Hikma Health at no cost and is intended for use as is. If you choose to
          use our Application, then you agree to the collection and use of information in relation
          to this policy. The Personal Information that we collect is used for providing and
          improving the Application. We will not use or share your information with anyone except as
        ...
        <View style={$section}>
          ...
          <Text>
            ...
            identifiable information that can be used to contact or identify you. Additionally, you
            may use the Application to collect patient health information. In this case, personally
            identifiable information may include, but is not limited to your name, email address,
            and patient health information ("Personal Information"). All information that is
            collected by the Application is encrypted and will not be shared with third parties for
            any reason at any time. Personal information that is collected will be retained by us
            and used as described in this privacy policy. The app does use third party services
            provided by Google Play Services that may collect information used to identify you. All
            data collected and used by third party services is described in the privacy policy of
        ...
        <View style={$section}>
          ...
          <Text>
            ...
            configuration of the app when utilizing our Application, the time and date of your use
            of the Application, and other statistics.
          </Text>
        </View>
        <View style={$section}>
          ...
          <Text>
            ...
            stored on your device{"'"}s internal memory. This Application does not use these
            “cookies” explicitly. However, the Application may use third party code and libraries
        ...
        <View style={$section}>
          ...
          <Text>
            ...
            us. Therefore, we strongly advise you to review the Privacy Policy of these websites. We
        ...
        <View style={$section}>
          ...
          <Text>
            This Privacy Policy is effective as of October 1, 2020 and will remain in effect except
            ...
            on this page will constitute your acknowledgment of the modifications and your consent
        ...
        <View style={$section}>
          ...
          <Text>
            ...
            using the Application, you are agreeing to be bound by the terms and conditions of this
            Agreement. If you do not agree to the terms of this Agreement, do not download or use
            the Application.
          </Text>
        </View>
        <View style={$section}>
        ...
        <View style={$section}>
          ...
          <Text>
            ...
            termination of this Agreement, you shall cease all use of the Application and delete all
            copies of the Application from your mobile device or from your electronic devices.
          </Text>
        </View>
        <View style={$section}>
