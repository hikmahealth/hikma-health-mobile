    ...
    <Screen preset="scroll" style={$screen}>
      <View style={$formContainer}>
        <FormProvider {...formMethods}>
          ...
          <ControlledTextField label={translate("treatmentPlan")} name="treatmentPlan" />

          <ControlledTextField label={translate("treatmentSession")} name="treatmentSession" />

          <ControlledTextField label={translate("recommendations")} name="recommendations" />

          <HorizontalRadioGroup
            options={yesNoOptions}
            value={yesNoFromBoolean(formMethods.watch("referral"))}
            onChange={(value: string) => formMethods.setValue("referral", booleanFromYesNo(value))}
