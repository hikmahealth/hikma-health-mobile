    ...
    <Screen preset="scroll">
      <View style={$formContainer}>
        <FormProvider {...formMethods}>
          <ControlledTextField label={translate("examination")} name="examination" />
          <ControlledTextField
            label={translate("generalObservations")}
            name="generalObservations"
          />
          <ControlledTextField label={translate("diagnosis")} name="diagnosis" />
          <ControlledTextField label={translate("treatment")} name="treatment" />
          ...
          {eval(formMethods.watch("referral") as unknown as string) && (
            <ControlledTextField multiline numberOfLines={5} label={""} name="referralText" />
          )}
...
export const ExaminationDisplay = (props: ExaminationDisplayProps) => {
  ...
  return (
    <View>
      ...
      <Text>
        {translate("covid19")}: {metadataObj.referral ? translate("yes") : translate("no")}
      </Text>
      <Text>
        {translate("referral")}: {metadataObj.referral ? translate("yes") : translate("no")}
      </Text>
