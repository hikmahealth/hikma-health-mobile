...
import { i18n, isRTL, translate } from '../i18n';
...
export const TextInput = forwardRef(function TextInput(props: TextInputProps, ref: Ref<RNTextInputProps>) {
  ...
  const input = useRef<RNTextInputProps>()
