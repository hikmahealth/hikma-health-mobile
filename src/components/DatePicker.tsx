...
type ControlledDatePickerButtonProps = Omit<DatePickerProps, "date"> & UseControllerProps

export const ControlledDatePickerButton = (props: ControlledDatePickerButtonProps) => {
  ...
  return (
    <>
      <DatePickerButton date={field.value || new Date()} onDateChange={field.onChange} {...inputProps} />
