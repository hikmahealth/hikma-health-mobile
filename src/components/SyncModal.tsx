...
import { Modal, Portal, Button, Provider, ActivityIndicator, MD3Colors } from "react-native-paper"
          ...
          >
            ...
            {state.matches("fetch") && (
              <View style={$statusContainer}>
                <IconedText iconName="download" label="Fetching data from server" />
              </View>
            )}
            ...
            {state.matches("resolveConflicts") && (
              <View style={$statusContainer}>
                ...
                />
                <IconedText iconName="source-merge" label="Resolving Conflicts" />
              </View>
            )}
...
const IconedText = (props: {
  ...
  return (
    <View style={[$iconedTextContainer, { paddingLeft: props.indent ? 20 : 0 }]}>
      <Icon name={props.iconName} size={20} color={props.iconColor ?? "black"} />
